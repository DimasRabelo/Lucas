<?php
if (isset($_POST['nomeAlnos'])) {
 
    $nomeAluno = $_POST['nomeAluno'];
    $dataNascAluno = $_POST['dataNascAluno'];
    $emailAluno = $_POST['emailAlunos'];
    $senhaAluno = $_POST['senhaAlunos'];
    ...
    $aluno->emailAluno = $emailAlunos;
    $aluno->senhaAluno = $senhaAlunos;
...
<div class="estruturaCadAluno">
    ...
    <form action="index.php?p=aluno&e=cadastrar" method="POST" enctype="multipart/form-data">
